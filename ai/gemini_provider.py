...
class GeminiProvider(AIProvider):
    ...
    def generate_post(
        ...
        # Build the prompt
        prompt = f"""You are an expert LinkedIn content strategist who creates engaging, professional posts that drive engagement.
...
"""
    ...
    def generate_comment(
        ...
        prompt = f"""You are a real LinkedIn professional writing natural, conversational comments. Write like a human - be direct, authentic, and avoid corporate buzzwords or AI-sounding language. No emojis. Do not wrap your response in quotes.

Generate a thoughtful comment for this LinkedIn post:
...
"""
        ...
        prompt = f"""You are a LinkedIn growth expert who optimizes content for maximum engagement.
...
"""
    ...
    def analyze_post(
        ...
        prompt = f"""You are a LinkedIn analytics expert who predicts post performance and provides actionable insights.

Analyze this LinkedIn post and predict its engagement potential:
...
"""
    ...
    def suggest_topics(
        ...
        prompt = f"""You are a LinkedIn content strategist who identifies trending topics and engagement opportunities.

Suggest 5 engaging LinkedIn post topics for someone in the {industry} industry.
...
"""
    ...
    def suggest_hashtags(
        ...
        prompt = f"""You are a LinkedIn hashtag research expert who identifies trending and relevant hashtags.

Suggest {count} relevant LinkedIn hashtags for a post about: {topic}
