...
class OpenAIProvider(AIProvider):
    """OpenAI GPT-4 provider for content generation"""
...
"""
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are an expert LinkedIn content strategist who creates engaging, professional posts that drive engagement."},
...
"""
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are a real LinkedIn professional writing natural, conversational comments. Write like a human - be direct, authentic, and avoid corporate buzzwords or AI-sounding language. No emojis. Do not wrap your response in quotes."},
                {"role": "user", "content": prompt}
            ],
            temperature=self.temperature,
...
"""
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are a LinkedIn growth expert who optimizes content for maximum engagement."},
                {"role": "user", "content": prompt}
            ],
            temperature=self.temperature,
            max_tokens=self.max_tokens
...
"""
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are a LinkedIn analytics expert who predicts post performance and provides actionable insights."},
                {"role": "user", "content": prompt}
            ],
...
"""
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are a LinkedIn content strategist who identifies trending topics and engagement opportunities."},
                {"role": "user", "content": prompt}
            ],
...
"""
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are a LinkedIn hashtag research expert who identifies trending and relevant hashtags."},
                {"role": "user", "content": prompt}
            ],
            temperature=0.7,
            max_tokens=300
