...
class AnthropicProvider(AIProvider):
    """Anthropic Claude provider for content generation"""
    ...
    def __init__(self, config: dict):
        ...
        self.model = anthropic_config.get('model', 'claude-3-sonnet-20240229')
        self.max_tokens = anthropic_config.get('max_tokens', 1000)
...
"""
        ...
        message = self.client.messages.create(
            ...
            system="You are an expert LinkedIn content strategist who creates engaging, professional posts that drive engagement."
        )
...
"""
        ...
        message = self.client.messages.create(
            model=self.model,
            max_tokens=int(max_length / 2),  # Rough token estimate
            messages=[
                {
                    "role": "user",
                    "content": prompt
            ...
            system="You are a real LinkedIn professional writing natural, conversational comments. Write like a human - be direct, authentic, and avoid corporate buzzwords or AI-sounding language. No emojis. Do not wrap your response in quotes."
        )
...
"""
        ...
        message = self.client.messages.create(
            ...
            system="You are a LinkedIn growth expert who optimizes content for maximum engagement."
        )
...
"""
        ...
        message = self.client.messages.create(
            ...
            system="You are a LinkedIn analytics expert who predicts post performance and provides actionable insights."
        )
...
"""
        ...
        message = self.client.messages.create(
            ...
            system="You are a LinkedIn content strategist who identifies trending topics and engagement opportunities."
        )
...
"""
        ...
        message = self.client.messages.create(
            ...
            system="You are a LinkedIn hashtag research expert who identifies trending and relevant hashtags."
        )
